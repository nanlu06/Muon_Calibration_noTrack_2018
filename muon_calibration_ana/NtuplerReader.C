...
void NtuplerReader::Loop( TString path, TString num, int nvtx_sel )
{
   ...
   double ecal1x1, ecal3x3,ecal5x5, ecal15x15,ecal25x25, weight, ISOR04, p, energy, pt, eta, eEcal_o, phi, pt2, eta2, phi2, e1dx, e2dx, e3dx, e4dx, e5dx, e6dx, e7dx, e1, e2, e3, e4, e5, e6, e7, e1_o, e2_o, e3_o, e4_o, e5_o, e6_o, e7_o;
   double gain1, gain2,gain3,gain4,gain5,gain6,gain7, cc1, cc2, cc3, cc4, cc5, cc6, cc7;
   ...
   */
   ...
   double chg, chg2, e1r, e12r, e123r, e23r, e1s, e15, e2r, e2s, e25, e3r, e3s, e35, e4r, e4s, e45, e5r, e5s, e55, e6r, e6s, e65, e7r, e7s, e75;
   ...
   tree->Branch("inlumi", &inlumi, "inlumi/D");
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      for(int k = 0; k<nmuon; k ++){
           ...
           e1s = (hcal_edepth11_o->at(k) + hcal_edepth21_o->at(k) + hcal_edepth31_o->at(k) + hcal_edepth41_o->at(k) + hcal_edepth51_o->at(k) + hcal_edepth61_o->at(k) + hcal_edepth71_o->at(k));
           e2s = (hcal_edepth12_o->at(k) + hcal_edepth22_o->at(k) + hcal_edepth32_o->at(k) + hcal_edepth42_o->at(k) + hcal_edepth52_o->at(k) + hcal_edepth62_o->at(k) + hcal_edepth72_o->at(k));
           e3s = (hcal_edepth13_o->at(k) + hcal_edepth23_o->at(k) + hcal_edepth33_o->at(k) + hcal_edepth12_o->at(k) + hcal_edepth22_o->at(k) + hcal_edepth32_o->at(k) + hcal_edepth43_o->at(k) + hcal_edepth53_o->at(k) + hcal_edepth63_o->at(k) + hcal_edepth73_o->at(k));
           e4s = (hcal_edepth13_o->at(k) + hcal_edepth23_o->at(k) + hcal_edepth33_o->at(k) + hcal_edepth44_o->at(k) + hcal_edepth54_o->at(k) + hcal_edepth64_o->at(k) + hcal_edepth74_o->at(k));
           e5s = (hcal_edepth14_o->at(k) + hcal_edepth24_o->at(k) + hcal_edepth34_o->at(k) + hcal_edepth45_o->at(k) + hcal_edepth55_o->at(k) + hcal_edepth65_o->at(k) + hcal_edepth75_o->at(k));
           e6s = (hcal_edepth15_o->at(k) + hcal_edepth25_o->at(k) + hcal_edepth35_o->at(k) + hcal_edepth46_o->at(k) + hcal_edepth56_o->at(k) + hcal_edepth66_o->at(k) + hcal_edepth76_o->at(k));
           e7s = (hcal_edepth16_o->at(k) + hcal_edepth26_o->at(k) + hcal_edepth36_o->at(k) + hcal_edepth47_o->at(k) + hcal_edepth57_o->at(k) + hcal_edepth67_o->at(k) + hcal_edepth77_o->at(k));

           e1r = e1s/e1_o;
           e12r =( e1s+e2s)/e1_o;
           e123r =( e1s+e2s+e3s)/e1_o;
